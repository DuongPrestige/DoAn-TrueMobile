...
router.get('/get-product-detail-image-by-id', controllers.getDetailProductImageById)
router.get('/get-all-product-detail-config-by-id', controllers.getAllProductDetailConfigById)
router.get('/get-detail-product-detail-config-by-id', controllers.getDetailProductDetailConfigById)
...
router.post('/create-product-detail-image', controllers.createNewProductDetailImage)
router.put('/update-product-detail-image', controllers.updateProductDetailImage)
router.delete('/delete-product-detail-image', controllers.deleteProductDetailImage)

// product detail config table
router.post('/create-product-detail-config', controllers.createNewProductDetailConfig)
router.put('/update-product-detail-config', controllers.updateProductDetailConfig)
router.delete('/delete-product-detail-config', controllers.deleteProductDetailConfig)
